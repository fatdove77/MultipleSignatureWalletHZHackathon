...
import { useUpdateOwnerProcess } from '@/hooks/useUpdateOwnerProcess';
  ...
  return (
    ...
    >
      <Grid
        ...
        container
        alignItems={'center'}
      ><HomeOutlined style={{ marginRight: ".3rem" }} />修改拥有者权重</Grid>
      ...
      >
        ...
        {/* 被拒绝显示提示 or  显示交易信息 */}
        {
          1
            ...
            >
              {
                transferInfo?.newWeightOwner.map((item:any,index:number)=>{
                  return (
                    <Grid
                      container
                      flexDirection={"column"}
