...
import { useSwitchOwnerProcess } from '@/hooks/useSwitchOwnerProcess';
  ...
  return (
    ...
    >
      <Grid
        ...
        container
        alignItems={'center'}
      ><HomeOutlined style={{ marginRight: ".3rem" }} />替换拥有者</Grid>
            ...
            ? <>
              ...
              >
                ...
                >
                  ...
                  >
                    <Image
                      src={transferInfo?.walletInfo?.data?.ownerArr[transferInfo?.switchIndex]?.img}
                      width={30}
                      height={30}
                      alt=""
                      style={{
                    ...
                    <Typography
                      ...
                      名称:{transferInfo?.walletInfo?.data?.ownerArr[transferInfo?.switchIndex]?.name}
                    </Typography>
                    <Typography
                      sx={{
                        color: "#000000",
                      ...
                      地址:{formatAddress(transferInfo?.walletInfo?.data?.ownerArr[transferInfo?.switchIndex]?.address ?? "")}
                    </Typography>
                    {
                      transferInfo?.walletInfo?.data?.signType === 0
                        ? <></>
                        : <Typography
                          ...
                          权重:{transferInfo?.walletInfo?.data?.ownerArr[transferInfo?.switchIndex]?.weight ?? ""}%
                        </Typography>
                    }
                  </Grid>
                  <Grid
              ...
              >
                ...
                >
                  ...
                  >
                    <Image
                      src={ethereumAddressImage(transferInfo?.switchAddress ?? "") ?? ""}
                      width={30}
                      height={30}
                      alt=""
                      style={{
                    ...
                    <Typography
                      ...
                      地址:{formatAddress(transferInfo?.switchAddress ?? "")}
                    </Typography>
                    {
                      transferInfo?.walletInfo?.data?.signType === 0
                        ? <></>
