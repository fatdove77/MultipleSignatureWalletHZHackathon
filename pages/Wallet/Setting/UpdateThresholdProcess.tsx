...
function UpdateThresholdProcess() {
  ...
  return (
    ...
    >
      <Grid
        ...
        container
        alignItems={'center'}
      ><HomeOutlined style={{ marginRight: ".3rem" }} />修改进程</Grid>
            ...
            {/* 发送 or 在链上被拒绝 */}
            {
              1
                ...
                >
                  ...
                  {
                    transferInfo?.walletInfo?.data?.signType === 0 ? "修改门限值" : "修改权重门限值"
                  }
                </Typography>
                : <Typography
                  sx={{
              ...
              >
                ...
                >
                  ...
                  >
                    现门限值 : {
                      transferInfo?.walletInfo?.data?.signType === 0
                        ? `${transferInfo?.newDoor} out of ${transferInfo?.walletInfo?.data?.ownerArr?.length}`
                        : `权重 ≥ ${transferInfo?.newWeight}`
                    }
                  </Typography>
                </Grid>
              </Grid>
...
export default UpdateThresholdProcess