...
import { useDeleteOwnerProcess } from '@/hooks/useDeleteOwnerProcess';
import useWallet from '@/hooks/useWallet';
import { Spin } from 'antd';
function DeleteOwnerProcess() {
  ...
  return (
    ...
    >
      <Grid
        ...
        container
        alignItems={'center'}
      ><HomeOutlined style={{ marginRight: ".3rem" }} />踢除成员进程</Grid>
          ...
          1
            ...
            >
              ...
              >
                ...
                >
                  <Image
                    src={transferInfo?.walletInfo?.data?.ownerArr[transferInfo.deleteIndex]?.img}
                    width={30}
                    height={30}
                    alt=""
                    style={{
                  ...
                  <Typography
                    ...
                    名称:{transferInfo?.walletInfo?.data?.ownerArr[transferInfo.deleteIndex]?.name}
                  </Typography>
                  <Typography
                    sx={{
                      color: "#000000",
                    ...
                    地址:{formatAddress(transferInfo?.walletInfo?.data?.ownerArr[transferInfo.deleteIndex]?.address ?? "")}
                  </Typography>
                  {
                    transferInfo?.walletInfo?.data?.signType === 0
                      ? <></>
                      : <Typography
                        ...
                        权重:{transferInfo?.walletInfo?.data?.ownerArr[transferInfo.deleteIndex]?.weight}%
                      </Typography>
                  }
                </Grid>
                <Grid
...
export default DeleteOwnerProcess