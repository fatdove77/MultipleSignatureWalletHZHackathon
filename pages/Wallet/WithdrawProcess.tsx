...
import { useTradeProcess } from '@/hooks/useTradeProcess';
  ...
  return (
    ...
    >
      <Grid
        ...
        container
        alignItems={'center'}
      ><HomeOutlined style={{ marginRight: ".3rem" }} />交易进程</Grid>
          ...
          0
            ...
            >
              ...
              >
                ...
                >
                  {`${transferInfo?.amount} ${transferInfo?.coinInfo?.name}`}
                </Typography>
                <Typography
                  sx={{
                    color: "#000000",
              ...
              >
                ...
                >
                  ...
                  >
                    {formatAddress(transferInfo?.receiveAddress ?? "")}
      ...
      >
        ...
        >
          ...
          <Typography sx={{ color: "#555555", fontWeight: "400", textAlign: "center", fontSize: ".875rem" }}>{transferInfo?.nonce}</Typography>
        </Grid>
        ...
        >
          ...
          <Typography sx={{ color: "#555555", fontWeight: "400", textAlign: "center", fontSize: ".875rem" }}>{transferInfo?.createTime}</Typography>
        </Grid>
      </Grid>
