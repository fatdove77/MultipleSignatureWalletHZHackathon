...
import { useCallContractProcess } from '@/hooks/useCallContractProcess';
import { Spin } from 'antd';
function CallContractProcess() {
  ...
  return (
    ...
    >
      <Grid
        ...
        container
        alignItems={'center'}
      ><HomeOutlined style={{ marginRight: ".3rem" }} />调用合约进程</Grid>
              ...
              >
                ...
                >
                  ...
                  <Grid
                    ...
                    >
                      {formatAddress(transferInfo?.callContract??"")}
                    </Typography>
                  </Grid>
                </Grid>
                <Grid
                ...
                >
                  ...
                  <Grid
                    ...
                    >
                      {formatAddress(transferInfo?.payload??"")}
                    </Typography>
                  </Grid>
                </Grid>
              </Grid>
...
export default CallContractProcess